List<Map> figuresDetails = [
        [ test_type: "clean", testGroup: "api_validation", description: "testu walidacji istnienia klucza API"],
        [ test_type: "clean", testGroup: "key_validation", description: "testu walidacji istnienia rekordu w bazie"],
        [ test_type: "clean", testGroup: "crud", description: "testu operacji CRUD"],
        [ test_type: "clean", testGroup: "all", description: "testu: walidacji istnienia klucza API, walidacji istnienia, operacji CRUD równolegle"],
        [ test_type: "full", testGroup: "api_validation", description: "testu walidacji istnienia klucza API"],
        [ test_type: "full", testGroup: "key_validation", description: "testu walidacji istnienia rekordu w bazie"],
        [ test_type: "full", testGroup: "crud", description: "testu operacji CRUD"],
        [ test_type: "full", testGroup: "all", description: "testu: walidacji istnienia klucza API, walidacji istnienia, operacji CRUD równolegle"],
]
...
int i = 1
def firstFigurePosition = '!ht'
def secondFigurePosition = '!ht'
figuresDetails.each { Map figureDetails ->
    ...
    languages.each { Map lang ->
        ...
        def templateWithSubfigures = """\\pgfplotsset{grid style={dashed}}
\\begin{figure}[$firstFigurePosition]
...
\\begin{figure}[$secondFigurePosition]
...
\\end{figure}"""
        ...
        texFile.append(templateWithSubfigures)
        texFile.append('\n\n')
    }
    println ""
}
