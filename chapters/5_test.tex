...
\begin{tikzpicture}
  ...
  \end{axis}
\end{tikzpicture}
\caption{Liczba żądań obsłużonych przez aplikację w ciągu sekundy} 
...
\begin{tikzpicture}
  ...
  \end{axis}
\end{tikzpicture}
\caption{Rozkład czasów odpowiedzi (95\%)}
\label{fig:tomcat_clean_key_validation_td}
\end{subfigure}
 
\caption{Tomcat 8 - test walidacji istnienia rekordu w bazie}
\label{fig:tomcat_clean_key_validation_performance}
\end{figure}
