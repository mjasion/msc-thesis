...
\caption{Tomcat 8 - testy wydajności: walidacji istnienia klucza API, walidacji istnienia, operacji CRUD równolegle}
\label{fig:tomcat_clean_all}
\end{figure}
...
\caption{Jetty 9 - testy wydajności: walidacji istnienia klucza API, walidacji istnienia, operacji CRUD równolegle}
\label{fig:jetty_clean_all}
\end{figure}
...
\caption{Go - testy wydajności: walidacji istnienia klucza API, walidacji istnienia, operacji CRUD równolegle}
\label{fig:go_clean_all}
\end{figure}
