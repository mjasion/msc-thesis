...
\caption{Tomcat 8 - testy wydajności operacji CRUD}
\label{fig:tomcat_clean_crud}
\end{figure}
...
\caption{Jetty 9 - testy wydajności operacji CRUD}
\label{fig:jetty_clean_crud}
\end{figure}
...
\caption{Go - testy wydajności operacji CRUD}
\label{fig:go_clean_crud}
\end{figure}
